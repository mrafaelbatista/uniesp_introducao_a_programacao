...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\mrafa\devSourceCode\uniesp_introducao_a_programacao\p1a\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\mrafa\devSourceCode\uniesp_introducao_a_programacao\p1a\venv\Scripts\deactivate.nu'
